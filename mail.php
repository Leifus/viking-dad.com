...
$project_name = "viking-dad.com"; // Change value to your site name.
$admin_email  = "leif@viking-dad.com"; // Change value to your valid email address (where a message will be sent).
$form_subject = "Message from viking-dad.com"; // Change value to your own message subject.
